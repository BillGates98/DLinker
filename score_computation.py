...
ScoreComputation(input_good_validation='./outputs/good_to_validate.csv', 
                input_same_as_file='./validations/valid_same_as.ttl', chunk_size=1000).run()
